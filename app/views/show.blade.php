...
<p>
    ...
    @if($friend->paid)
    <div style="width:100%; height:60px; background:#67ff6e; border-bottom-width: 1px; border-bottom-color: #000000; vertical-align: middle; margin-top:1px; padding-top:30px;">
